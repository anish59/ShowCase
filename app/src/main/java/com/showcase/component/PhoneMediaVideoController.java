	...
	public static void loadAllVideoMedia(Context mContext) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					cursor= MediaStore.Video.query(ShowCaseApplication.applicationContext.getContentResolver(), MediaStore.Video.Media.EXTERNAL_CONTENT_URI, projectionPhotos);
					  if (cursor != null) {
...
//												ShowCaseApplication.applicationContext.getContentResolver(),imageId,
